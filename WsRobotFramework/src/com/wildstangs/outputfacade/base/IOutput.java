...
public interface IOutput {
    ...
    /**
     * Method to force the output element to update.
     * Used by the output facade to update all elements.
     */
    abstract void update();
    /**
     * Method to notify the output element that config values have been
     * updated and should be re-read.  Used by the output facade to 
     * notify all output elements.
     */
