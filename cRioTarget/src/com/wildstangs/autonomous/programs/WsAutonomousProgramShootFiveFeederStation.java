...
public class WsAutonomousProgramShootFiveFeederStation extends WsAutonomousProgram {
    ...
    public void defineSteps() {
        ...
        programSteps[19] = new WsAutonomousStepStartDriveUsingMotionProfile(firstFeederDriveDistance.getValue(), firstFeederDriveVelocity.getValue());
        programSteps[20] = new WsAutonomousStepWaitForDriveMotionProfile();
        programSteps[21] = new WsAutonomousStepStopDriveUsingMotionProfile(); 
        programSteps[22] = new WsAutonomousStepQuickTurn(firstFeederAngle.getValue());
        programSteps[23] = new WsAutonomousStepStartDriveUsingMotionProfile(secondFeederDriveDistance.getValue(), secondFeederDriveVelocity.getValue());
        programSteps[24] = new WsAutonomousStepWaitForDriveMotionProfile();
        programSteps[25] = new WsAutonomousStepStopDriveUsingMotionProfile();
        programSteps[26] = new WsAutonomousStepQuickTurn(secondFeederAngle.getValue());
    }

    public String toString() {
        return "Shoot Five Frisbees, drive to feeder station";
    }
}
