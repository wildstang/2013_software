    ...
    public void defineSteps()
    {
        ...
        programSteps[14] = ssc1;
            ssc1.addStep(new WsAutonomousStepIntakeMotorPullFrisbeesIn());
                WsAutonomousParallelFinishedOnAnyStepGroup pfa1 = new WsAutonomousParallelFinishedOnAnyStepGroup("Time out or take in a frisbee");
                pfa1.addStep(new WsAutonomousStepDelay(FunnelatorLoadDelay.getValue()));
                pfa1.addStep(new WsAutonomousStepWaitForFunnelatorLimitSwitchTrueToFalse());
            ssc1.addStep(pfa1);
                WsAutonomousParallelFinishedOnAnyStepGroup pfa2 = new WsAutonomousParallelFinishedOnAnyStepGroup("Time out or take in a frisbee");
                pfa2.addStep(new WsAutonomousStepDelay(FunnelatorLoadDelay.getValue()));
                pfa2.addStep(new WsAutonomousStepWaitForFunnelatorLimitSwitchTrueToFalse());
            ssc1.addStep(pfa2);
