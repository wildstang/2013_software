...
public class Counter extends SensorBase implements CounterBase, LiveWindowSendable {
    ...
    public static class Mode {
         ...
         * mode: two pulse
         */
        public static final Counter.Mode kTwoPulse = new Counter.Mode(kTwoPulse_val);
        /**
         * mode: semi period
         */
        public static final Counter.Mode kSemiperiod = new Counter.Mode(kSemiperiod_val);
        /**
         * mode: pulse length
         */
        public static final Counter.Mode kPulseLength = new Counter.Mode(kPulseLength_val);
        /**
         * mode: external direction
         */
        public static final Counter.Mode kExternalDirection = new Counter.Mode(kExternalDirection_val);
    ...
    private void initCounter(final Counter.Mode mode) {
     ...
     */
    public Counter() {
        initCounter(Counter.Mode.kTwoPulse);
    }
    ...
    public Counter(CounterBase.EncodingType encodingType, DigitalSource upSource, DigitalSource downSource, boolean inverted) {
        initCounter(Counter.Mode.kExternalDirection);
